...
<div class="topnav" id="myTopnav">
    ...
    <a href="" style="float: right; font-weight: bold; border: 1.5px solid white; border-right: none; margin-bottom: -3px;"><img class="icono" src='../../vista/img/user_icon.png' alt="icono de usuario">migyanari</a>
